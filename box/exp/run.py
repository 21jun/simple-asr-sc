...
class CustomDataCollator():
    ...
    def collate_batch(self, batch):
        ...
        inputs = ["generate ASR error : "+ item['Pred'] for item in batch]
        labels = [item['gold'] for item in batch]
...
def main():
    ...
    predict_dataset = json.load(open(args.predict_path, "r"))
    ...
    eval_metrics = {metric: evaluate.load(metric) for metric in ["cer", "wer"]}
